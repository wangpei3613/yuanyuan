...
public class PropertiesCopyUtil {
	...
	public static void copyProperties(Object from, Object to) throws Exception {
		copyPropertiesExclude(from, to, new String[]{});
	}
	...
	public static void copyPropertiesInclude(Object from, Object to,
			String includsStrings) throws Exception{
		copyPropertiesInclude(from, to, includsStrings.split(","));  
	}
	public static void copyPropertiesExclude(Object from, Object to,
			String excludsStrings) throws Exception {
		copyPropertiesExclude(from, to, excludsStrings.split(","));   
	}
}
