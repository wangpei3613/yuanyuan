...
//		Money mon = new Money();
//		System.out.println(mon.NumToRMBStr(0.94));
//		System.out.println(mon.NumToRMBStr(-101.999));
//		System.out.println(mon.NumToRMBStr(840407.12));
...
//	}
	...
	public static String NumToRMBStr(Object obj) {
		Double val = null;
		if(obj instanceof Double) val = (Double)obj;
		else {
			String str = StringUtil.sNull(obj);
			if(str.equals("")) val = 0.00;
	...
	public static void main(String[] args) {
		System.out.println(NumToRMBStr("1"));
	}
}
