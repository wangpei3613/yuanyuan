...
<body>
	<form action="">
		...
		<table class="sen-edit-table">
			<tr>
				<td style="width: 35%;">流程编码：<span class="sen-required">*</span></td>
				<td><input type="text" class="sen-edit-element easyui-textbox" name="processcode" value="${v.processcode }" required/></td> 
			</tr>
			<tr>
				<td>流程名称：<span class="sen-required">*</span></td>
