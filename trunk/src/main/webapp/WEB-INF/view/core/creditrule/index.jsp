...
<head>
	...
	var row = {};
	var menu = {
		param:{path:'${path}/sen/core/creditrule/toParam?id=',id:null}
	};
	$(function(){
		disableTabs();
		$('#tabs').tabs({
...
<body id="tabs" class="easyui-tabs" style="width:100%;height:100%;">
	<div data-options="title:'征信规则配置',fit:true,cls:'pd3 sen-noscroll'">
		<iframe scrolling="auto" frameborder="0"  src="${path }/sen/core/creditrule/toRule?__=${param.__}" style="width:100%;height:100%;"></iframe>
	</div>
	<div data-options="title:'征信规则参数配置',fit:true,cls:'pd3 sen-noscroll'">
		<iframe data-id="param" scrolling="auto" frameborder="0"  src="" style="width:100%;height:100%;"></iframe>
	</div>
</body>
</html>