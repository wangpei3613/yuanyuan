...
<head>
	...
	var row = {};
	var menu = {
		parameter:{path:'${path}/model/index/config/toParameter?id=',id:null},
		conversion:{path:'${path}/model/index/config/toConversion?id=',id:null},
	};
	$(function(){
		disableTabs();
		$('#tabs').tabs({
...
<body id="tabs" class="easyui-tabs" style="width:100%;height:100%;">
	<div data-options="title:'指标配置',fit:true,cls:'pd3 sen-noscroll'">
		<iframe scrolling="auto" frameborder="0"  src="${path }/model/index/config/toIndex?__=${param.__}" style="width:100%;height:100%;"></iframe>
	</div>
	<div data-options="title:'指标参数配置',fit:true,cls:'pd3 sen-noscroll'">
		<iframe data-id="parameter" scrolling="auto" frameborder="0"  src="" style="width:100%;height:100%;"></iframe>
	</div>
	<div data-options="title:'指标分值转换配置',fit:true,cls:'pd3 sen-noscroll'">
