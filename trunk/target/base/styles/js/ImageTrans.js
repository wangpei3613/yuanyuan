...
ImageTrans.modes = function(){
	...
	function initImg(img, container) {
		$$D.setStyle( img, {
			position: "absolute",
			border: 0, padding: 0, margin: 0, maxWidth: "100%", maxHeight: "100%",//重置样式
...
ImageTrans.prototype._initialize = (function(){
	...
	var init = ImageTrans.prototype._initialize,
		methods = {
			"init": function(){
				...
				var me = this;
				this._mrSTART = function(e){start(e,me)};//$$F.bind( start, this );
	...
	function start(e,me){
		...
		element.onmousemove = function(e_move){
