...
<body>
	<form action="">
		...
		<input type="hidden" name="alloid" value="${v.alloid }"/>  
		<table class="sen-edit-table">
			...
			<tr>
				<td>优先级：<span class="sen-required">*</span></td>
			...
			<tr>
				<td>是否终止规则：<span class="sen-required">*</span></td>
				<td><input type="text" class="sen-edit-element easyui-combobox" value="${v.isend }" data-options="url:'${path}/sys/sysData?type=SEN_IF'" name="isend" required/></td> 
				<td></td>
				<td></td>
			</tr>
			<tr>
