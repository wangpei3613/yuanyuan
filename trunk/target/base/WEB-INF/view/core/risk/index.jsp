...
<head>
	...
	var row = {};
	var menu = {
		rule:{path:'${path}/sen/core/risk/toRiskRule?id=',id:null}
	};
	$(function(){
		disableTabs();
		$('#tabs').tabs({
...
<body id="tabs" class="easyui-tabs" style="width:100%;height:100%;">
	<div data-options="title:'风险模型配置',fit:true,cls:'pd3 sen-noscroll'">
		<iframe scrolling="auto" frameborder="0"  src="${path }/sen/core/risk/toRisk?__=${param.__}" style="width:100%;height:100%;"></iframe>
	</div>
	<div data-options="title:'风险模型规则配置',fit:true,cls:'pd3 sen-noscroll'">
